...
static inline kk_box_t kk_std_core_exn_throw_exn(kk_std_core_exn__exception exn_0, kk_context_t* _ctx) { /* forall<a> (exn : exception) -> exn a */ 
  ...
  {
    struct kk_std_core_hnd_Ev* _con_x102 = kk_std_core_hnd__as_Ev(ev_10032, _ctx);
    ...
    kk_std_core_exn__exn_dup(h, _ctx);
    {
      ...
      }
      {
        ...
        return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x12, (_fun_unbox_x12, m, ev_10032, kk_std_core_exn__exception_box(exn_0, _ctx), _ctx), _ctx);
      }
    }
  }
}
...
static inline kk_std_core_exn__error kk_std_core_exn_error_fs__mlift_try_10030(kk_box_t _y_x10022, kk_context_t* _ctx) { /* forall<a,e> (a) -> <exn|e> error<a> */ 
  return kk_std_core_exn__new_Ok(_y_x10022, _ctx);
}
...
static inline kk_function_t kk_std_core_exn_new_catch_fun154(kk_function_t hndl, kk_context_t* _ctx) {
...
static inline kk_function_t kk_std_core_exn_new_catch_fun155(kk_function_t hndl, kk_std_core_exn__exception x, kk_context_t* _ctx) {
...
static inline kk_function_t kk_std_core_exn_new_catch_fun158(kk_function_t _b_x64_68, kk_context_t* _ctx) {
...
static inline kk_function_t kk_std_core_exn_new_catch_fun160(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_core_exn_catch_fun160, _ctx)
  return kk_function_static_dup(_fself,kk_context());
}


static inline kk_box_t kk_std_core_exn_catch(kk_function_t hndl, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (hndl : (exception) -> e a, action : () -> <exn|e> a) -> e a */ 
  kk_function_t _b_x64_68 = kk_std_core_exn_new_catch_fun154(hndl, _ctx); /*(m : hnd/marker<736,735>, hnd/ev<exn>, x : exception) -> 736 638*/;
...
static inline kk_box_t kk_std_core_exn_on_exit(kk_function_t hndler, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (hndler : () -> e (), action : () -> e a) -> e a */ 
  kk_box_t _x_x163 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx), _ctx); /*956*/
