// Koka generated module: std/core/order, koka version: 3.2.3, platform: 64-bit
...
kk_std_core_types__order2 kk_std_core_order_default_fs__mlift_order2_10013(kk_box_t x, kk_box_t y, kk_std_core_types__order _y_x10012, kk_context_t* _ctx) { /* forall<a,e> (x : a, y : a, order) -> e order2<a> */ 
  if (kk_std_core_types__is_Eq(_y_x10012, _ctx)) {
    kk_box_drop(y, _ctx);
    return kk_std_core_types__new_Eq2(x, _ctx);
  }
  if (kk_std_core_types__is_Lt(_y_x10012, _ctx)) {
...
static kk_box_t kk_std_core_order_default_fs_order2_fun45(kk_function_t _fself, kk_box_t _b_x3, kk_context_t* _ctx) {
  ...
  kk_std_core_types__order _y_x10012_8 = kk_std_core_types__order_unbox(_b_x3, KK_OWNED, _ctx); /*order*/;
  kk_std_core_types__order2 _x_x46 = kk_std_core_order_default_fs__mlift_order2_10013(x, y, _y_x10012_8, _ctx); /*order2<258>*/
...
static kk_box_t kk_std_core_order_default_fs_order2_fun47(kk_function_t _fself, kk_box_t _b_x4, kk_context_t* _ctx) {
  ...
  kk_box_t y = _self->y; /* 258 */
  kk_drop_match(_self, {kk_box_dup(x, _ctx);kk_box_dup(y, _ctx);}, {}, _ctx)
  kk_std_core_types__order _y_x10012_0_9 = kk_std_core_types__order_unbox(_b_x4, KK_OWNED, _ctx); /*order*/;
  kk_std_core_types__order2 _x_x48;
  if (kk_std_core_types__is_Eq(_y_x10012_0_9, _ctx)) {
    kk_box_drop(y, _ctx);
    _x_x48 = kk_std_core_types__new_Eq2(x, _ctx); /*order2<105>*/
    goto _match_x49;
  }
  if (kk_std_core_types__is_Lt(_y_x10012_0_9, _ctx)) {
