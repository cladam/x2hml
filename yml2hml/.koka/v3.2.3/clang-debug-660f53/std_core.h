...
struct kk_std_core_const_fun105__t {
...
static inline kk_function_t kk_std_core_new_const_fun105(kk_box_t kkloc_default, kk_context_t* _ctx) {
  struct kk_std_core_const_fun105__t* _self = kk_function_alloc_as(struct kk_std_core_const_fun105__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_const_fun105, kk_context());
...
static inline kk_function_t kk_std_core_const(kk_box_t kkloc_default, kk_context_t* _ctx) { /* forall<a,b> (default : a) -> ((x : b) -> a) */ 
  return kk_std_core_new_const_fun105(kkloc_default, _ctx);
}
...
static inline bool kk_std_core_default_fs_cmp_fs__lp__at_mlift_x_10082_eq__eq__rp_(kk_std_core_types__order _y_x10032, kk_context_t* _ctx) { /* forall<e> (order) -> e bool */ 
  if (kk_std_core_types__is_Eq(_y_x10032, _ctx)) {
    return true;
  }
  {
    return false;
...
static inline bool kk_std_core_default_fs__lp__at_mlift_x_10083_excl__eq__rp_(bool _y_x10033, kk_context_t* _ctx) { /* forall<e> (bool) -> e bool */ 
  if (_y_x10033) {
    return false;
  }
  {
...
static inline bool kk_std_core_default_fs_cmp_fs__lp__at_mlift_x_10084_gt__rp_(kk_std_core_types__order _y_x10034, kk_context_t* _ctx) { /* forall<e> (order) -> e bool */ 
  return kk_std_core_order__lp__eq__eq__rp_(_y_x10034, kk_std_core_types__new_Gt(_ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_fold(kk_integer_t upto, kk_box_t init, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (upto : int, init : a, f : (int, a) -> e a) -> e a */ 
  kk_integer_t _x_x132 = kk_integer_add_small_const(upto, -1, _ctx); /*int*/
  return kk_std_core_range_fs_fold(kk_integer_from_small(0), _x_x132, init, f, _ctx);
}
...
static inline kk_box_t kk_std_core_fold_while(kk_integer_t n, kk_box_t init, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (n : int, init : a, f : (int, a) -> e maybe<a>) -> e a */ 
  kk_integer_t _x_x140 = kk_integer_add_small_const(n, -1, _ctx); /*int*/
  return kk_std_core_range_fs_fold_while(kk_integer_from_small(0), _x_x140, init, f, _ctx);
}
 
// monadic lift

static inline bool kk_std_core_default_fs_cmp_fs__lp__at_mlift_x_10087_lt__rp_(kk_std_core_types__order _y_x10044, kk_context_t* _ctx) { /* forall<e> (order) -> e bool */ 
  return kk_std_core_order__lp__eq__eq__rp_(_y_x10044, kk_std_core_types__new_Lt(_ctx), _ctx);
}
...
static inline bool kk_std_core_default_fs_cmp_fs__lp__at_mlift_x_10088_gt__eq__rp_(kk_std_core_types__order _y_x10045, kk_context_t* _ctx) { /* forall<e> (order) -> e bool */ 
  bool b_10068 = kk_std_core_order__lp__eq__eq__rp_(_y_x10045, kk_std_core_types__new_Lt(_ctx), _ctx); /*bool*/;
  if (b_10068) {
    return false;
  }
  {
...
static inline bool kk_std_core_default_fs_cmp_fs__lp__at_mlift_x_10089_lt__eq__rp_(kk_std_core_types__order _y_x10046, kk_context_t* _ctx) { /* forall<e> (order) -> e bool */ 
  bool b_10069 = kk_std_core_order__lp__eq__eq__rp_(_y_x10046, kk_std_core_types__new_Gt(_ctx), _ctx); /*bool*/;
  if (b_10069) {
    return false;
  }
  {
...
static inline kk_unit_t kk_std_core_range_fs_for(kk_integer_t start, kk_integer_t end, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (start : int, end : int, action : (int) -> e ()) -> e () */ 
  kk_integer_t _x_x155 = kk_integer_dup(start, _ctx); /*int*/
  kk_std_core_range_fs__lift_for_1901(action, end, _x_x155, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_for(kk_integer_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (n : int, action : (int) -> e ()) -> e () */ 
  kk_integer_t end_10008;
  kk_integer_t _x_x156 = kk_integer_dup(n, _ctx); /*int*/
  end_10008 = kk_integer_add_small_const(_x_x156, -1, _ctx); /*int*/
  kk_std_core_range_fs__lift_for_1901(action, end_10008, kk_integer_from_small(0), _ctx); return kk_Unit;
}
...
// lift anonymous function
struct kk_std_core_repeat_fun158__t {
  struct kk_function_s _base;
  kk_function_t action;
};
extern kk_unit_t kk_std_core_repeat_fun158(kk_function_t _fself, kk_integer_t i_0, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_new_repeat_fun158(kk_function_t action, kk_context_t* _ctx) {
  struct kk_std_core_repeat_fun158__t* _self = kk_function_alloc_as(struct kk_std_core_repeat_fun158__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_repeat_fun158, kk_context());
  _self->action = action;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_unit_t kk_std_core_repeat(kk_integer_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (n : int, action : () -> e ()) -> e () */ 
  kk_integer_t end_10013;
  kk_integer_t _x_x157 = kk_integer_dup(n, _ctx); /*int*/
  end_10013 = kk_integer_add_small_const(_x_x157, -1, _ctx); /*int*/
  kk_std_core_range_fs__lift_for_1901(kk_std_core_new_repeat_fun158(action, _ctx), end_10013, kk_integer_from_small(0), _ctx); return kk_Unit;
}
...
static inline kk_std_core_types__maybe kk_std_core_range_fs_for_while(kk_integer_t start, kk_integer_t end, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (start : int, end : int, action : (int) -> e maybe<a>) -> e maybe<a> */ 
  return kk_std_core_range_fs__lift_for_while_1902(action, end, start, _ctx);
}
...
static inline kk_std_core_types__maybe kk_std_core_for_while(kk_integer_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (n : int, action : (int) -> e maybe<a>) -> e maybe<a> */ 
  kk_integer_t end_10017 = kk_integer_add_small_const(n, -1, _ctx); /*int*/;
  return kk_std_core_range_fs__lift_for_while_1902(action, end_10017, kk_integer_from_small(0), _ctx);
}
...
static inline kk_box_t kk_std_core_stream_fs_head(kk_std_core__stream stream, kk_context_t* _ctx) { /* forall<a> (stream : stream<a>) -> a */ 
  {
    struct kk_std_core_Next* _con_x186 = kk_std_core__as_Next(stream, _ctx);
    kk_box_t _x = _con_x186->head;
...
static inline kk_std_core__stream kk_std_core_stream_fs_tail(kk_std_core__stream stream, kk_context_t* _ctx) { /* forall<a> (stream : stream<a>) -> stream<a> */ 
  {
    struct kk_std_core_Next* _con_x187 = kk_std_core__as_Next(stream, _ctx);
    kk_std_core__stream _x = _con_x187->tail;
