...
// Koka generated module: std/core/string, koka version: 3.2.3, platform: 64-bit
#include <kklib.h>
...
static inline bool kk_std_core_string__lp__lt__rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> bool */ 
  kk_std_core_types__order _x_x23 = kk_std_core_string_cmp(x, y, _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x23, kk_std_core_types__new_Lt(_ctx), _ctx);
}
...
static inline bool kk_std_core_string__lp__lt__eq__rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> bool */ 
  kk_std_core_types__order _x_x24 = kk_std_core_string_cmp(x, y, _ctx); /*order*/
  return kk_std_core_order__lp__lt__rp_(_x_x24, kk_std_core_types__new_Gt(_ctx), _ctx);
}

static inline bool kk_std_core_string__lp__gt__rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> bool */ 
  kk_std_core_types__order _x_x25 = kk_std_core_string_cmp(x, y, _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x25, kk_std_core_types__new_Gt(_ctx), _ctx);
}
...
static inline bool kk_std_core_string__lp__gt__eq__rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> bool */ 
  kk_std_core_types__order _x_x26 = kk_std_core_string_cmp(x, y, _ctx); /*order*/
  return kk_std_core_order__lp__gt__rp_(_x_x26, kk_std_core_types__new_Lt(_ctx), _ctx);
}
...
static inline kk_string_t kk_std_core_string_repeat(kk_string_t s, kk_integer_t n, kk_context_t* _ctx) { /* (s : string, n : int) -> string */ 
  kk_ssize_t _x_x27;
  kk_integer_t _x_x28 = kk_integer_dup(n, _ctx); /*int*/
  _x_x27 = kk_std_core_int_ssize__t(_x_x28, _ctx); /*ssize_t*/
  return kk_std_core_string_repeatz(s, _x_x27, _ctx);
}
...
static inline bool kk_std_core_string_is_empty(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> bool */ 
  kk_string_t _x_x30 = kk_string_empty(); /*string*/
  return kk_string_is_eq(s,_x_x30,kk_context());
}
...
static inline kk_string_t kk_std_core_string__lp__bar__bar__rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> string */ 
  bool _match_x18;
  kk_string_t _x_x32 = kk_string_dup(x, _ctx); /*string*/
  kk_string_t _x_x33 = kk_string_empty(); /*string*/
  _match_x18 = kk_string_is_eq(_x_x32,_x_x33,kk_context()); /*bool*/
  if (_match_x18) {
...
static inline bool kk_std_core_string_is_notempty(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> bool */ 
  kk_string_t _x_x35 = kk_string_empty(); /*string*/
  return kk_string_is_neq(s,_x_x35,kk_context());
}
...
static inline kk_string_t kk_std_core_string_trim(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> string */ 
  kk_string_t _x_x48 = kk_string_trim_left(s,kk_context()); /*string*/
  return kk_string_trim_right(_x_x48,kk_context());
}
...
static inline kk_std_core_types__list kk_std_core_string_sep_fs_split(kk_string_t s, kk_string_t sep, kk_context_t* _ctx) { /* (s : string, sep : string) -> list<string> */ 
  kk_vector_t v_10011 = kk_string_splitv(s,sep,kk_context()); /*vector<string>*/;
...
static inline kk_std_core_types__list kk_std_core_string_splitn_fs_split(kk_string_t s, kk_string_t sep, kk_integer_t n, kk_context_t* _ctx) { /* (s : string, sep : string, n : int) -> list<string> */ 
  ...
  _x_x49 = kk_std_core_int_ssize__t(_x_x50, _ctx); /*ssize_t*/
  v_10012 = kk_string_splitv_atmost(s,sep,_x_x49,kk_context()); /*vector<string>*/
