...
static inline kk_std_core_hnd__htag kk_std_core_hnd_ev_fs_htag(kk_std_core_hnd__ev ev, kk_context_t* _ctx) { /* forall<a> (ev : ev<a>) -> htag<a> */ 
  {
    struct kk_std_core_hnd_Ev* _con_x307 = kk_std_core_hnd__as_Ev(ev, _ctx);
    kk_std_core_hnd__htag _x = _con_x307->htag;
...
static inline kk_box_t kk_std_core_hnd_local_var(kk_box_t init, kk_function_t action, kk_context_t* _ctx) { /* forall<a,b,e,h> (init : a, action : (local-var<h,a>) -> <local<h>|e> b) -> <local<h>|e> b */ 
  ...
  kk_box_t res;
  kk_ref_t _x_x351 = kk_ref_dup(loc, _ctx); /*local-var<4257,4254>*/
  res = kk_function_call(kk_box_t, (kk_function_t, kk_ref_t, kk_context_t*), action, (action, _x_x351, _ctx), _ctx); /*4255*/
...
static inline kk_box_t kk_std_core_hnd_finally(kk_function_t fin, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (fin : () -> e (), action : () -> e a) -> e a */ 
  kk_box_t _x_x356 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx), _ctx); /*4444*/
...
static inline kk_box_t kk_std_core_hnd_resume(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : a) -> e b */ 
  {
    ...
    kk_std_core_hnd__resume_result _x_x373 = kk_std_core_hnd__new_Deep(x, _ctx); /*hnd/resume-result<74,75>*/
    return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x, (_x, _x_x373, _ctx), _ctx);
  }
}
...
static inline kk_box_t kk_std_core_hnd_resume_shallow(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : a) -> e1 b */ 
  {
    kk_function_t _x = r.k;
    kk_std_core_hnd__resume_result _x_x374 = kk_std_core_hnd__new_Shallow(x, _ctx); /*hnd/resume-result<74,75>*/
...
static inline kk_box_t kk_std_core_hnd_finalize(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : b) -> e b */ 
  {
    kk_function_t _x = r.k;
    kk_std_core_hnd__resume_result _x_x375 = kk_std_core_hnd__new_Finalize(x, _ctx); /*hnd/resume-result<74,75>*/
...
static inline kk_box_t kk_std_core_hnd__perform1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,c,e> (ev : ev<c>, op : forall<e1,d> (c<e1,d>) -> clause1<a,b,c,e1,d>, x : a) -> e b */ 
  {
    ...
    kk_box_t h = _con_x379->hnd;
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause1 _match_x249 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause1<5306,5307,5308,835,836>*/;
    {
      kk_function_t f = _match_x249.clause;
...
struct kk_std_core_hnd_under1_fun387__t {
...
static inline kk_function_t kk_std_core_hnd_new_under1_fun387(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under1_fun387__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under1_fun387__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_under1_fun387, kk_context());
  _self->ev = ev;
...
static inline kk_box_t kk_std_core_hnd_under1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : (a) -> e b, x : a) -> e b */ 
  ...
  w0 = kk_evv_swap(_x_x385,kk_context()); /*hnd/evv<_5497>*/
  kk_box_t y = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_context_t*), op, (op, x, _ctx), _ctx); /*5584*/;
  if (kk_yielding(kk_context())) {
    kk_box_drop(y, _ctx);
    kk_evv_drop(w0, _ctx);
    return kk_std_core_hnd_yield_cont(kk_std_core_hnd_new_under1_fun387(ev, _ctx), _ctx);
  }
  {
...
// lift anonymous function
struct kk_std_core_hnd_clause_control1_fun401__t {
  struct kk_function_s _base;
  kk_function_t clause;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_control1_fun401(kk_function_t clause, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control1_fun401__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control1_fun401__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_control1_fun401, kk_context());
  _self->clause = clause;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_function_t kk_std_core_hnd_new_clause_control1_fun402(kk_function_t clause, kk_box_t x, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control1_fun402__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control1_fun402__t, 3, _ctx);
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_control1(kk_function_t clause, kk_context_t* _ctx) { /* forall<a,b,e,c,d> (clause : (x : a, k : (b) -> e d) -> e d) -> clause1<a,b,c,e,d> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_control1_fun401(clause, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail_noop1_fun407__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noop1_fun407(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noop1_fun407__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noop1_fun407__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail_noop1_fun407, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_tail_noop1(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d> (op : (c) -> e d) -> clause1<c,d,b,e,a> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_tail_noop1_fun407(op, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd__perform0(kk_std_core_hnd__ev ev, kk_function_t op, kk_context_t* _ctx) { /* forall<a,e,b> (ev : ev<b>, op : forall<e1,c> (b<e1,c>) -> clause0<a,b,e1,c>) -> e a */ 
  {
    struct kk_std_core_hnd_Ev* _con_x413 = kk_std_core_hnd__as_Ev(ev, _ctx);
    int32_t m = _con_x413->marker;
    kk_box_t h = _con_x413->hnd;
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause0 _match_x242 = kk_function_call(kk_std_core_hnd__clause0, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause0<6617,6619,1012,1013>*/;
    {
      kk_function_t f = _match_x242.clause;
...
// lift anonymous function
struct kk_std_core_hnd_under0_fun416__t {
  struct kk_function_s _base;
  kk_std_core_hnd__ev ev;
};
extern kk_box_t kk_std_core_hnd_under0_fun416(kk_function_t _fself, kk_function_t cont, kk_box_t res, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_under0_fun416(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under0_fun416__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under0_fun416__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_under0_fun416, kk_context());
  _self->ev = ev;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
// lift anonymous function
struct kk_std_core_hnd_under0_fun419__t {
  struct kk_function_s _base;
  kk_std_core_hnd__ev ev;
};
extern kk_box_t kk_std_core_hnd_under0_fun419(kk_function_t _fself, kk_function_t cont_0, kk_box_t res_0, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_under0_fun419(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under0_fun419__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under0_fun419__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_under0_fun419, kk_context());
  _self->ev = ev;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_box_t kk_std_core_hnd_under0(kk_std_core_hnd__ev ev, kk_function_t op, kk_context_t* _ctx) { /* forall<a,e,b> (ev : ev<b>, op : () -> e a) -> e a */ 
  ...
  kk_evv_t _x_x414;
  {
    struct kk_std_core_hnd_Ev* _con_x415 = kk_std_core_hnd__as_Ev(ev, _ctx);
    kk_evv_t w = _con_x415->hevv;
    kk_evv_dup(w, _ctx);
    _x_x414 = w; /*hnd/evv<5350>*/
  }
  w0 = kk_evv_swap(_x_x414,kk_context()); /*hnd/evv<_6641>*/
  kk_box_t y = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), op, (op, _ctx), _ctx); /*6715*/;
  kk_unit_t __ = kk_Unit;
  kk_evv_set(w0,kk_context());
  if (kk_yielding(kk_context())) {
    kk_box_drop(y, _ctx);
    return kk_std_core_hnd_yield_cont(kk_std_core_hnd_new_under0_fun416(ev, _ctx), _ctx);
  }
  {
    kk_datatype_ptr_dropn(ev, (KK_I32(3)), _ctx);
    return y;
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail_noop0_fun433__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noop0_fun433(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noop0_fun433__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noop0_fun433__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail_noop0_fun433, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause0 kk_std_core_hnd_clause_tail_noop0(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c> (op : () -> e c) -> clause0<c,b,e,a> */ 
  return kk_std_core_hnd__new_Clause0(kk_std_core_hnd_new_clause_tail_noop0_fun433(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_value_fun434__t {
  struct kk_function_s _base;
  kk_box_t v;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_value_fun434(kk_box_t v, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_value_fun434__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_value_fun434__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_value_fun434, kk_context());
  _self->v = v;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause0 kk_std_core_hnd_clause_value(kk_box_t v, kk_context_t* _ctx) { /* forall<a,e,b,c> (v : a) -> clause0<a,b,e,c> */ 
  return kk_std_core_hnd__new_Clause0(kk_std_core_hnd_new_clause_value_fun434(v, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control2_fun449__t {
  struct kk_function_s _base;
  kk_function_t clause;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_control2_fun449(kk_function_t clause, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control2_fun449__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control2_fun449__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_control2_fun449, kk_context());
  _self->clause = clause;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control2_fun450__t {
  struct kk_function_s _base;
  kk_function_t clause;
  kk_box_t x1;
  kk_box_t x2;
...
static inline kk_function_t kk_std_core_hnd_new_clause_control2_fun450(kk_function_t clause, kk_box_t x1, kk_box_t x2, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control2_fun450__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control2_fun450__t, 4, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_control2_fun450, kk_context());
  _self->clause = clause;
  _self->x1 = x1;
  _self->x2 = x2;
  return kk_datatype_from_base(&_self->_base, kk_context());
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_control2(kk_function_t clause, kk_context_t* _ctx) { /* forall<a,b,c,e,d,a1> (clause : (x1 : a, x2 : b, k : (c) -> e a1) -> e a1) -> clause2<a,b,c,d,e,a1> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_control2_fun449(clause, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail2_fun454__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail2_fun454(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail2_fun454__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail2_fun454__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail2_fun454, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_tail2(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1> (op : (c, d) -> e a1) -> clause2<c,d,a1,b,e,a> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_tail2_fun454(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_tail_noop2_fun455__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noop2_fun455(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noop2_fun455__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noop2_fun455__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail_noop2_fun455, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_tail_noop2(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1> (op : (c, d) -> e a1) -> clause2<c,d,a1,b,e,a> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_tail_noop2_fun455(op, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd__perform2(kk_std_core_hnd__ev evx, kk_function_t op, kk_box_t x, kk_box_t y, kk_context_t* _ctx) { /* forall<a,b,c,e,d> (evx : ev<d>, op : forall<e1,a1> (d<e1,a1>) -> clause2<a,b,c,d,e1,a1>, x : a, y : b) -> e c */ 
  {
    struct kk_std_core_hnd_Ev* _con_x456 = kk_std_core_hnd__as_Ev(evx, _ctx);
    int32_t m = _con_x456->marker;
    kk_box_t h = _con_x456->hnd;
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause2 _match_x234 = kk_function_call(kk_std_core_hnd__clause2, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause2<8121,8122,8123,8125,1252,1253>*/;
    {
...
static inline kk_box_t kk_std_core_hnd_xperform1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : forall<e1,d> (c<e1,d>) -> clause1<a,b,c,e1,d>, x : a) -> e b */ 
  {
    struct kk_std_core_hnd_Ev* _con_x459 = kk_std_core_hnd__as_Ev(ev, _ctx);
    int32_t m = _con_x459->marker;
    kk_box_t h = _con_x459->hnd;
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause1 _match_x233 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause1<8331,8332,8334,1294,1295>*/;
    {
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail3_fun466__t {
  struct kk_function_s _base;
  kk_function_t op;
};
extern kk_box_t kk_std_core_hnd_clause_tail3_fun466(kk_function_t _fself, kk_box_t _b_x126, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_clause_tail3_fun466(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail3_fun466__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail3_fun466__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail3_fun466, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_tail3(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1,b1> (op : (c, d, a1) -> e b1) -> clause1<(c, d, a1),b1,b,e,a> */ 
  return kk_std_core_hnd_clause_tail1(kk_std_core_hnd_new_clause_tail3_fun466(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_tail_noop3_fun467__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noop3_fun467(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noop3_fun467__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noop3_fun467__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail_noop3_fun467, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_tail_noop3(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1,b1> (op : (c, d, a1) -> e b1) -> clause1<(c, d, a1),b1,b,e,a> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_tail_noop3_fun467(op, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd__perform3(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_context_t* _ctx) { /* forall<a,b,c,d,e,a1> (ev : ev<a1>, op : forall<e1,b1> (a1<e1,b1>) -> clause1<(a, b, c),d,a1,e1,b1>, x1 : a, x2 : b, x3 : c) -> e d */ 
  {
    struct kk_std_core_hnd_Ev* _con_x470 = kk_std_core_hnd__as_Ev(ev, _ctx);
    int32_t m = _con_x470->marker;
    kk_box_t h = _con_x470->hnd;
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause1 _match_x227 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause1<(8949, 8950, 8951),8952,8954,1450,1451>*/;
    {
      kk_function_t _fun_unbox_x148 = _match_x227.clause;
      kk_box_t _x_x471;
      kk_std_core_types__tuple3 _x_x472 = kk_std_core_types__new_Tuple3(x1, x2, x3, _ctx); /*(141, 142, 143)*/
      _x_x471 = kk_std_core_types__tuple3_box(_x_x472, _ctx); /*45*/
      return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x148, (_fun_unbox_x148, m, ev, _x_x471, _ctx), _ctx);
    }
  }
}
...
static inline kk_box_t kk_std_core_hnd__perform4(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_box_t x4, kk_context_t* _ctx) { /* forall<a,b,c,d,a1,e,b1> (ev : ev<b1>, op : forall<e1,c1> (b1<e1,c1>) -> clause1<(a, b, c, d),a1,b1,e1,c1>, x1 : a, x2 : b, x3 : c, x4 : d) -> e a1 */ 
  {
    struct kk_std_core_hnd_Ev* _con_x490 = kk_std_core_hnd__as_Ev(ev, _ctx);
    int32_t m = _con_x490->marker;
    kk_box_t h = _con_x490->hnd;
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause1 _match_x220 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause1<(9644, 9645, 9646, 9647),9648,9650,1606,1607>*/;
    {
      kk_function_t _fun_unbox_x193 = _match_x220.clause;
      kk_box_t _x_x491;
      kk_std_core_types__tuple4 _x_x492 = kk_std_core_types__new_Tuple4(kk_reuse_null, 0, x1, x2, x3, x4, _ctx); /*(150, 151, 152, 153)*/
      _x_x491 = kk_std_core_types__tuple4_box(_x_x492, _ctx); /*45*/
      return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x193, (_fun_unbox_x193, m, ev, _x_x491, _ctx), _ctx);
    }
  }
}
...
static inline kk_box_t kk_std_core_hnd__open_none0(kk_function_t f, kk_context_t* _ctx) { /* forall<a,e,e1> (f : () -> e a) -> e1 a */ 
  kk_evv_t w = kk_evv_swap_create0(kk_context()); /*hnd/evv<9858>*/;
  kk_box_t x = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), f, (f, _ctx), _ctx); /*9856*/;
...
static inline kk_box_t kk_std_core_hnd__open_none1(kk_function_t f, kk_box_t x1, kk_context_t* _ctx) { /* forall<a,b,e,e1> (f : (a) -> e b, x1 : a) -> e1 b */ 
  kk_evv_t w = kk_evv_swap_create0(kk_context()); /*hnd/evv<9926>*/;
  kk_box_t x = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_context_t*), f, (f, x1, _ctx), _ctx); /*9924*/;
  kk_unit_t keep = kk_Unit;
  kk_evv_set(w,kk_context());
  return x;
}
...
static inline kk_box_t kk_std_core_hnd__open_none2(kk_function_t f, kk_box_t x1, kk_box_t x2, kk_context_t* _ctx) { /* forall<a,b,c,e,e1> (f : (a, b) -> e c, x1 : a, x2 : b) -> e1 c */ 
  kk_evv_t w = kk_evv_swap_create0(kk_context()); /*hnd/evv<10007>*/;
  kk_box_t x = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), f, (f, x1, x2, _ctx), _ctx); /*10005*/;
  kk_unit_t keep = kk_Unit;
  kk_evv_set(w,kk_context());
  return x;
}
...
static inline kk_box_t kk_std_core_hnd__open_none3(kk_function_t f, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_context_t* _ctx) { /* forall<a,b,c,d,e,e1> (f : (a, b, c) -> e d, x1 : a, x2 : b, x3 : c) -> e1 d */ 
  kk_evv_t w = kk_evv_swap_create0(kk_context()); /*hnd/evv<10101>*/;
  kk_box_t x = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_box_t, kk_box_t, kk_context_t*), f, (f, x1, x2, x3, _ctx), _ctx); /*10099*/;
  kk_unit_t keep = kk_Unit;
  kk_evv_set(w,kk_context());
  return x;
}
...
static inline kk_box_t kk_std_core_hnd__open_none4(kk_function_t f, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_box_t x4, kk_context_t* _ctx) { /* forall<a,b,c,d,a1,e,e1> (f : (a, b, c, d) -> e a1, x1 : a, x2 : b, x3 : c, x4 : d) -> e1 a1 */ 
  kk_evv_t w = kk_evv_swap_create0(kk_context()); /*hnd/evv<10208>*/;
  kk_box_t x = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_box_t, kk_box_t, kk_box_t, kk_context_t*), f, (f, x1, x2, x3, x4, _ctx), _ctx); /*10206*/;
  kk_unit_t keep = kk_Unit;
  kk_evv_set(w,kk_context());
  return x;
}
...
static inline kk_std_core_types__either kk_std_core_hnd_unsafe_try_finalize(kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (action : () -> e a) -> e either<yield-info,a> */ 
  kk_box_t _x_x521 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx), _ctx); /*11909*/
  return kk_std_core_hnd_try_finalize_prompt(_x_x521, _ctx);
}
